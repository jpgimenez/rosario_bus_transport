"""RosarioBus data update coordinator."""
...
class RosarioBusDataUpdateCoordinator(DataUpdateCoordinator):
    """Class to manage fetching RosarioBus data."""
    ...
    async def _async_update_data(self) -> dict[str, Any]:
        ...
        def _update_data() -> dict:
            ...
            except (RosarioBusHTTPError, RosarioBusFormatError) as ex:
